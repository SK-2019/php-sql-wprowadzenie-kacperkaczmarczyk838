...
<head>
 ...
 <div class="nav">
<a class="nav4" href="index.php">Strona Główna</a>
...
echo("<li>SELECT * FROM pracownicy,organizacja WHERE id_org=dzial and imie NOT LIKE '%a' order by  nazwa_dzial asc, zarobki asc</li>");
